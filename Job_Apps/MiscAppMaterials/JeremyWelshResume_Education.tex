...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science, Physics}{Sep 2020 - Jun 2022}
...
%	   {\scriptsize \textit{Courses: Operating Systems, Analysis Of Algorithms, Artificial %Intelligence, Machine Learning, Probability and Statistics and Network Security.}}
    ...
    \resumeSubheading
      {University of Oregon}{Eugene, OR}
      {Bachelor of Science, Mathematics and Physics}{Sep 2016 - June 2020}
...
\section{Work Experience}
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
    {Tutor}{Aug 2023 – Present}{LA Tutors 123}{Remote}
    
    \begin{itemize}[label={$\diamond$}]
    \itemsep0em %{description} [font=$\bullet$]
    	\item {Provided private tutoring in math and physics for courses in middle school, high school, and college.}
	\item {Designed personalized supplementary course curricula to suit individual learning needs of students.}
...
% newpage
	...
	\item {Engaged in team efforts to improve the quality of tutoring services provided.}
...
\begin{description}[font=$\bullet$]
	...
	\item{Led and supervised discussions and games related to mathematical concepts and reasoning.}
	\end{itemize} %{description}
	
	\resumeSubheading
    {Camp Counselor}{Jul 2016}
    {Dharma Rain Zen Center}{Portland, OR}
    
    \begin{itemize}[label={$\diamond$}]
    \itemsep0em %{description} [font=$\bullet$]
	\item{Supervised children aged 10-18 for a week long overnight summer camp.}
	\item{Led discussions and activities related to mindfulness, meditation, and concepts from Buddhist philosophy.}
	\end{itemize} %{description}
